                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-[1fr_auto] items-center">
                                    ...
                                    <div class="hidden lg:inline-block">
                                        <img src="{{asset('frontend/assets/img/elemnts/element-light-lime-curve-arrow.svg')}}" alt="element-light-lime-curve-arrow" width="284" height="153" class="h-auto max-w-52 lg:inline-block xl:max-w-full" />
                                    </div>
                                </div>
                            </div>
                            <!-- Footer Left Block -->
                            ...
                            <div>
                                ...
                                <form action="#" method="post" class="flex flex-col gap-y-6">
                                    ...
                                    <button type="submit" class="btn-primary relative justify-start pr-20 md:pr-[118px]">
                                        Send message
                                        <span class="absolute right-[5px] inline-flex h-[50px] w-[50px] items-center justify-center rounded-[50%] bg-black"><img src="{{asset('frontend/assets/img/icons/icon-buttery-white-arrow-right.svg')}}" alt="icon-buttery-white-arrow-right" width="34" height="28" /></span>
                                    </button>
                                </form>
                            </div>
                            <!-- Footer Right Block -->
                ...
                <div class="py-[35px]">
                    ...
                    <div class="container">
                        <div class="flex flex-wrap justify-center gap-x-[30px] gap-y-4 lg:justify-between">
                            <a href="index.html">
                                <img src="{{asset('frontend/assets/img/logo-buttery-white.svg')}}" alt="logo-buttery-white" width="121" height="24" />
                            </a>
