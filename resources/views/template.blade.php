...
<!-- Mirrored from prium.github.io/phoenix/v1.18.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 02:27:43 GMT -->
...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('frontend1/assets/img/favicons/apple-touch-icon.png')}}">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('frontend1/assets/img/favicons/favicon.ico')}}">
    <link rel="manifest" href="{{asset('frontend1/assets/img/favicons/manifest.json')}}">
    <meta name="msapplication-TileImage" content="{{asset('frontend1/assets/img/favicons/mstile-150x150.png')}}">
    <meta name="theme-color" content="#ffffff">
    <script src="{{asset('frontend1/vendors/simplebar/simplebar.min.js')}}"></script>
    <script src="{{asset('frontend1/assets/js/config.js')}}"></script>
    ...
    <link href="{{asset('frontend1/vendors/simplebar/simplebar.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('frontend1/unicons.iconscout.com/release/v4.0.8/css/line.css')}}">
    <link href="{{asset('frontend1/assets/css/theme-rtl.min.css')}}" type="text/css" rel="stylesheet" id="style-rtl">
    <link href="{{asset('frontend1/assets/css/theme.min.css')}}" type="text/css" rel="stylesheet" id="style-default">
    <link href="{{asset('frontend1/assets/css/user-rtl.min.css')}}" type="text/css" rel="stylesheet" id="user-style-rtl">
    <link href="{{asset('frontend1/assets/css/user.min.css')}}" type="text/css" rel="stylesheet" id="user-style-default">
    <script>
  ...
  <body>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('frontend1/vendors/popper/popper.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/anchorjs/anchor.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/is/is.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/fontawesome/all.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/lodash/lodash.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/list.js/list.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/feather-icons/feather.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/dayjs/dayjs.min.js')}}"></script>
    <script src="{{asset('frontend1/vendors/leaflet/leaflet.js')}}"></script>
    <script src="{{asset('frontend1/vendors/leaflet.markercluster/leaflet.markercluster.js')}}"></script>
    <script src="{{asset('frontend1/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js')}}"></script>
    <script src="{{asset('frontend1/assets/js/phoenix.js')}}"></script>
    <script src="{{asset('frontend1/vendors/echarts/echarts.min.js')}}"></script>
    <script src="{{asset('frontend1/assets/js/ecommerce-dashboard.js')}}"></script>
  </body>


<!-- Mirrored from prium.github.io/phoenix/v1.18.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 02:29:07 GMT -->
</html>